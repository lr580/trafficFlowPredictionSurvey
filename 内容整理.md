...
- 车站：地铁/车站拓扑图，数十数百个点，地铁公交线路图为空间依赖
...
(T-ZS2 论述说 T-ZS9 指出)：优点是解释性比 ML 好

statistics-based models have better model interpretability, whereas ML-based models are more flexible   
